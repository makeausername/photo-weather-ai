...
describe("account center foundation", () => {
  ...
  it("renders a session-backed authenticated account dashboard", () => {
    ...
    expect(html).toContain('data-collapsible-section="安全设置"');
    expect(html).toContain('data-collapsible-section="绑定方式"');
    expect(html).toContain('data-collapsible-section="注销账户"');
