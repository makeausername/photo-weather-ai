...
function minimalTerrainHorizonAssessment(terrain: GenericTerrainInput): TerrainHorizonAssessment {
  return {
    location: {
      latitude: 30.12,
      longitude: 118.16,
    ...
    observerElevationMeters: terrain.elevationMeters,
    target: "milky_way",
    targetAzimuthDegrees: 180,
    targetAltitudeDegrees: 22,
    horizonAltitudeDegrees: 0,
    obstructionClearanceDegrees: 22,
    ...
    qualitativeFallback: {
      ...
      summaryZh: "Synthetic fixture horizon keeps Cloud Sea regression terrain display complete.",
    },
    professionalDiagnostics: {
      calculationRuleZh: "synthetic fixture",
      sampleCount: 0,
      validSampleCount: 0,
      usedDirectionalProfile: false,
      notesZh: ["Synthetic regression fixture."],
    },
  };
}
...
function makeFixture(
  ...
  const terrainHorizonAssessment = minimalTerrainHorizonAssessment(terrain);
  ...
  const result = {
    ...
    terrainSummary: {
      ...
      terrainNoteZh: "Synthetic fixture terrain profile.",
      milkyWayAssessment: terrainHorizonAssessment,
      blockedDirectionsZh: [],
      obstructionNoteZh: "Synthetic fixture horizon is clear.",
      dataSource: "manual",
      dataSourceLabelZh: "synthetic terrain fixture",
      isMock: false,
      honestyNoteZh: "Synthetic terrain fixture for regression tests.",
    },
    terrainAnalysis: {
      dataSource: "manual",
      dataSourceLabelZh: "synthetic terrain fixture",
      ...
      terrainProfile: {
        ...
        terrainCloudSeaPotential: terrain.terrainScore >= 70 ? "high" : "low",
        terrainNoteZh: "Synthetic fixture terrain profile.",
        terrainNotesZh: "Synthetic fixture terrain profile.",
      },
      horizonProfile: {
        milkyWayHorizonAngle: 0,
        milkyWayAssessment: terrainHorizonAssessment,
        blockedDirectionsZh: [],
        obstructionNoteZh: "Synthetic fixture horizon is clear.",
      },
...
function minimalGlowAnalysis(): ForecastCalculationResult["glowAnalysis"] {
  return {
    ...
    lowCloudFogWallRisk: 40,
    glowLightPathObstructionRisk: 50,
    glowLightPathDataAvailability: "insufficient",
    glowLightPathConfidence: "low",
    cloudSuppressionRisk: 45,
    ...
    labels: {
      ...
      lowCloudFogWallRisk: "中",
      glowLightPathObstructionRisk: "中",
      cloudSuppressionRisk: "中",
      colorCarrier: "一般",
...
function minimalAstroAnalysis(): ForecastCalculationResult["astroAnalysis"] {
  return {
    ...
    assessment: {
      ...
      summaryZh: "Synthetic fixture astro assessment.",
      keyReasonsZh: [],
      riskWarningsZh: [],
    },
    bestAstroWindows: [],
    ...
    lightPollution: {
      ...
      ambientRiskLevelLabelZh: "Data unavailable",
      directionalRisk: [],
      confidence: "low",
      sampleCount: 0,
      validSampleCount: 0,
      lightPollutionNoteZh: "Synthetic fixture has no light pollution data.",
      starPenalty: 0,
      milkyWayPenalty: 0,
