...
export class QWeatherProvider implements WeatherProvider {
  ...
  normalizeHourlyWeather(input: unknown): readonly NormalizedHourlyWeather[] {
    ...
    const notes = ["和风天气小时预报未提供低云、中云、高云分层，cloudLow/cloudMid/cloudHigh 置为空。"];
