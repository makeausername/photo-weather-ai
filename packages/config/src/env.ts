...
export const serverEnvSchema = z
  .object({
    ...
    OPENAI_BASE_URL: optionalString.default("https://api.openai.com"),
    OPENAI_DEFAULT_MODEL: optionalString.default("gpt-4.1"),
    OPENAI_TIMEOUT_MS: optionalString,
    OPENAI_AI_EXPLAIN_PROMPT_MAX_CHARS: optionalString,
    OPENAI_INTERNAL_RELAY_TOKEN: optionalSecret,
    ENABLE_REAL_OPENAI: optInFlag,
