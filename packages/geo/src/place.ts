...
export function normalizePlaceResult(input: RawGeoPlaceResult): GeoPlaceResult {
  ...
  return {
    ...
    latitudeGcj02: coordinatesGcj02.latitude,
    longitudeGcj02: coordinatesGcj02.longitude,
    latitudeWgs84: coordinatesWgs84.latitude,
    longitudeWgs84: coordinatesWgs84.longitude,
    coordinatesGcj02,
    coordinatesWgs84,
