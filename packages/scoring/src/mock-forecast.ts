...
function buildCurrentWeatherFromHourly(input: {
  ...
  return {
    ...
    mountainFeelsLikeC: firstHour.mountainFeelsLikeC,
    tripodStabilityRisk: firstHour.tripodStabilityRisk,
    windChillNoteZh: firstHour.windChillNoteZh,
    clothingRiskNoteZh: firstHour.clothingRiskNoteZh,
    providerElevationMeters: firstHour.providerElevationMeters,
    selectedSpotElevationMeters: firstHour.selectedSpotElevationMeters,
    elevationDifferenceMeters: firstHour.elevationDifferenceMeters,
    terrainAdjustmentApplied: firstHour.terrainAdjustmentApplied,
    terrainAdjustmentReason: firstHour.terrainAdjustmentReason,
...
function flattenTerrainAnalysis(analysis: TerrainAnalysisSummary): TerrainSummary {
  return {
    ...
    longitudeGcj02: analysis.terrainProfile.longitudeGcj02,
    elevationMeters: analysis.terrainProfile.elevationMeters,
    elevationSource: analysis.terrainProfile.elevationSource,
    elevationConfidence: analysis.terrainProfile.elevationConfidence,
    terrainType: analysis.terrainProfile.terrainType,
    exposureType: analysis.terrainProfile.exposureType,
    viewingDirection: analysis.terrainProfile.viewingDirection,
    nearbyValleyElevationMeters: analysis.terrainProfile.nearbyValleyElevationMeters,
    localReliefMeters: analysis.terrainProfile.localReliefMeters,
    terrainNotesZh: analysis.terrainProfile.terrainNotesZh,
