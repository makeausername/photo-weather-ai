...
const actionLabels: Record<string, string> = {
  ...
  "auth.sms_login.code_send_suppressed": "短信登录验证码发送抑制",
  "auth.sms_login.code_sent": "发送短信登录验证码",
  "auth.sms_login.failure": "短信登录失败",
  "auth.sms_login.success": "短信登录成功",
  "auth.sms_login.verify_failure": "短信登录验证码校验失败",
